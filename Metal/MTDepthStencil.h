...
MT_INLINE MTStencilDescriptor mt_stencil_descriptor_create(void) {
...
MT_INLINE MTDepthStencilDescriptor mt_depth_stencil_descriptor_create(void) {
...
MT_INLINE MTStencilDescriptor mt_depth_stencil_descriptor_get_front_face_stencil(MTDepthStencilDescriptor desc) {
    return MT_MSG_SEND(void*, desc, MT_SEL("frontFaceStencil"));
}
...
MT_INLINE MTDevice mt_depth_stencil_state_get_device(MTDepthStencilState state) {
    return MT_MSG_SEND(void*, state, MT_SEL("device"));
}
