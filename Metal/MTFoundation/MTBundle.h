...
MT_INLINE MTBundle mt_bundle_main(void) {
    return MT_MSG_SEND_CLASS(void*, MT_CLASS("NSBundle"), MT_SEL("mainBundle"));
}

MT_INLINE MTBundle mt_bundle_with_path(MTString path) {
    return MT_MSG_SEND_CLASS_1(void*, MT_CLASS("NSBundle"), MT_SEL("bundleWithPath:"), id, path);
}

MT_INLINE MTBundle mt_bundle_init_with_path(MTBundle bundle, MTString path) {
    return MT_MSG_SEND_1(void*, bundle, MT_SEL("initWithPath:"), id, path);
}

MT_INLINE MTBundle mt_bundle_with_url(MTURL url) {
    return MT_MSG_SEND_CLASS_1(void*, MT_CLASS("NSBundle"), MT_SEL("bundleWithURL:"), id, url);
}

MT_INLINE MTBundle mt_bundle_init_with_url(MTBundle bundle, MTURL url) {
    return MT_MSG_SEND_1(void*, bundle, MT_SEL("initWithURL:"), id, url);
}

MT_INLINE MTBundle mt_bundle_for_class(void *aClass) {
    return MT_MSG_SEND_CLASS_1(void*, MT_CLASS("NSBundle"), MT_SEL("bundleForClass:"), Class, aClass);
}

MT_INLINE MTBundle mt_bundle_with_identifier(MTString identifier) {
    return MT_MSG_SEND_CLASS_1(void*, MT_CLASS("NSBundle"), MT_SEL("bundleWithIdentifier:"), id, identifier);
}
...
MT_INLINE void mt_bundle_all_bundles(MTBundle **outBundles, unsigned long *outCount) {
    id array = MT_MSG_SEND_CLASS(void*, MT_CLASS("NSBundle"), MT_SEL("allBundles"));
    if (outBundles && outCount && array) {
        ...
        *outCount = count;
        ...
        for (unsigned long i = 0; i < count; i++) {
            bundles[i] = MT_MSG_SEND_1(void*, array, MT_SEL("objectAtIndex:"), unsigned long, i);
        }
        *outBundles = bundles;
    }
}
...
MT_INLINE void mt_bundle_all_frameworks(MTBundle **outBundles, unsigned long *outCount) {
    id array = MT_MSG_SEND_CLASS(void*, MT_CLASS("NSBundle"), MT_SEL("allFrameworks"));
    if (outBundles && outCount && array) {
        unsigned long count = MT_MSG_SEND(unsigned long, array, MT_SEL("count"));
        *outCount = count;
        MTBundle *bundles = (MTBundle *)malloc(sizeof(MTBundle) * count);
...
MT_INLINE MTURL mt_bundle_url_for_resource_with_extension(MTBundle bundle, MTString name, MTString extension) {
    return MT_MSG_SEND_2(void*, bundle, MT_SEL("URLForResource:withExtension:"), id, name, id, extension);
}
...
MT_INLINE MTString mt_bundle_get_info_dict_value(MTBundle bundle, const char* key_utf8) {
    ...
    return MT_MSG_SEND_1(void*, bundle, MT_SEL("objectForInfoDictionaryKey:"), id, key);
}
...
MT_INLINE MTURL mt_bundle_url_for_resource_in_bundle(MTString name, MTString ext, MTString subdir, MTURL bundleURL) {
    return MT_MSG_SEND_CLASS_2(void*, MT_CLASS("NSBundle"), MT_SEL("URLForResource:withExtension:subdirectory:inBundleWithURL:"), id, name, id, ext);
...
MT_INLINE MTArray mt_bundle_urls_for_resources_in_bundle(MTString ext, MTString subdir, MTURL bundleURL) {
    return MT_MSG_SEND_CLASS_2(void*, MT_CLASS("NSBundle"), MT_SEL("URLsForResourcesWithExtension:subdirectory:inBundleWithURL:"), id, ext, id, subdir);
}

MT_INLINE MTURL mt_bundle_url_for_resource_(MTString name, MTString ext) {
    id mainBundle = MT_MSG_SEND_CLASS(void*, MT_CLASS("NSBundle"), MT_SEL("mainBundle"));
    return MT_MSG_SEND_2(void*, mainBundle, MT_SEL("URLForResource:withExtension:"), id, name, id, ext);
}
...
MT_INLINE MTURL mt_bundle_url_for_resource(MTBundle bundle, MTString name, MTString ext) {
    return MT_MSG_SEND_2(void*, bundle, MT_SEL("URLForResource:withExtension:"), id, name, id, ext);
}

MT_INLINE MTURL mt_bundle_url_for_resource_in_subdir(MTBundle bundle, MTString name, MTString ext, MTString subdir) {
    return MT_MSG_SEND_3(void*, bundle, MT_SEL("URLForResource:withExtension:subdirectory:"), id, name, id, ext, id, subdir);
}
...
MT_INLINE MTURL mt_bundle_url_for_resource_in_subdir_with_localization(MTBundle bundle, MTString name, MTString ext, MTString subdir, MTString localization) {
    return MT_MSG_SEND_4(void*, bundle, MT_SEL("URLForResource:withExtension:subdirectory:localization:"), id, name, id, ext, id, subdir, id, localization);
}

MT_INLINE MTArray mt_bundle_urls_for_resources_in_subdir(MTBundle bundle, MTString ext, MTString subdir) {
    return MT_MSG_SEND_2(void*, bundle, MT_SEL("URLsForResourcesWithExtension:subdirectory:"), id, ext, id, subdir);
}
...
MT_INLINE MTArray mt_bundle_urls_for_resources_in_subdir_with_localization(MTBundle bundle, MTString ext, MTString subdir, MTString localization) {
    return MT_MSG_SEND_3(void*, bundle, MT_SEL("URLsForResourcesWithExtension:subdirectory:localization:"), id, ext, id, subdir, id, localization);
}
...
MT_INLINE MTString mt_bundle_path_for_resource_in_dir(MTString name, MTString ext, MTString bundlePath) {
    return MT_MSG_SEND_CLASS_2(void*, MT_CLASS("NSBundle"), MT_SEL("pathForResource:ofType:inDirectory:"), id, name, id, ext);
}

MT_INLINE MTArray mt_bundle_paths_for_resources_in_dir(MTString ext, MTString bundlePath) {
    return MT_MSG_SEND_CLASS_2(void*, MT_CLASS("NSBundle"), MT_SEL("pathsForResourcesOfType:inDirectory:"), id, ext, id, bundlePath);
}

MT_INLINE MTString mt_bundle_path_for_resource_(MTString name, MTString ext) {
    id mainBundle = MT_MSG_SEND_CLASS(void*, MT_CLASS("NSBundle"), MT_SEL("mainBundle"));
    return MT_MSG_SEND_2(void*, mainBundle, MT_SEL("pathForResource:ofType:"), id, name, id, ext);
}
...
MT_INLINE MTString mt_bundle_path_for_resource(MTBundle bundle, MTString name, MTString ext) {
    return MT_MSG_SEND_2(void*, bundle, MT_SEL("pathForResource:ofType:"), id, name, id, ext);
}

MT_INLINE MTString mt_bundle_path_for_resource_in_dir_bundle(MTBundle bundle, MTString name, MTString ext, MTString subdir) {
    return MT_MSG_SEND_3(void*, bundle, MT_SEL("pathForResource:ofType:inDirectory:"), id, name, id, ext, id, subdir);
}
...
MT_INLINE MTString mt_bundle_path_for_resource_in_dir_with_localization(MTBundle bundle, MTString name, MTString ext, MTString subdir, MTString localization) {
    return MT_MSG_SEND_4(void*, bundle, MT_SEL("pathForResource:ofType:inDirectory:forLocalization:"), id, name, id, ext, id, subdir, id, localization);
}

MT_INLINE MTArray mt_bundle_paths_for_resources_in_dir_instance(MTBundle bundle, MTString ext, MTString subdir) {
    return MT_MSG_SEND_2(void*, bundle, MT_SEL("pathsForResourcesOfType:inDirectory:"), id, ext, id, subdir);
}
...
MT_INLINE MTArray mt_bundle_paths_for_resources_in_dir_with_localization(MTBundle bundle, MTString ext, MTString subdir, MTString localization) {
    return MT_MSG_SEND_3(void*, bundle, MT_SEL("pathsForResourcesOfType:inDirectory:forLocalization:"), id, ext, id, subdir, id, localization);
}
