...
MT_INLINE MTTexture mt_heap_create_texture_with_descriptor(MTHeap heap, MTTextureDescriptor desc) {
    return MT_MSG_SEND_1(void*, heap, MT_SEL("newTextureWithDescriptor:"), id, desc);
}

MT_INLINE MTTexture mt_heap_create_texture_at_offset(MTHeap heap, MTTextureDescriptor desc, uintptr_t offset) {
    return MT_MSG_SEND_2(void*, heap, MT_SEL("newTextureWithDescriptor:offset:"), id, desc, uintptr_t, offset);
}

MT_INLINE MTBuffer mt_heap_create_buffer(MTHeap heap, uintptr_t length, MTResourceOptions options) {
    return MT_MSG_SEND_2(void*, heap, MT_SEL("newBufferWithLength:options:"), uintptr_t, length, MTResourceOptions, options);
}
...
MT_INLINE MTBuffer mt_heap_create_buffer_at_offset(MTHeap heap, uintptr_t length, MTResourceOptions options, uintptr_t offset) {
    return MT_MSG_SEND_3(void*, heap, MT_SEL("newBufferWithLength:options:offset:"), uintptr_t, length, MTResourceOptions, options, uintptr_t, offset);
}
...
MT_INLINE void mt_heap_descriptor_set_storage_mode(MTHeapDescriptor desc, MTStorageMode mode) {
    MT_MSG_SEND_1(void, desc, MT_SEL("setStorageMode:"), MTStorageMode, mode);
}

MT_INLINE void mt_heap_descriptor_set_cpu_cache_mode(MTHeapDescriptor desc, MTCPUCacheMode mode) {
    MT_MSG_SEND_1(void, desc, MT_SEL("setCpuCacheMode:"), MTCPUCacheMode, mode);
}

MT_INLINE void mt_heap_descriptor_set_sparse_page_size(MTHeapDescriptor desc, MTSparsePageSize size) {
    MT_MSG_SEND_1(void, desc, MT_SEL("setSparsePageSize:"), MTSparsePageSize, size);
}

MT_INLINE void mt_heap_descriptor_set_hazard_tracking_mode(MTHeapDescriptor desc, MTHazardTrackingMode mode) {
    MT_MSG_SEND_1(void, desc, MT_SEL("setHazardTrackingMode:"), MTHazardTrackingMode, mode);
}

MT_INLINE void mt_heap_descriptor_set_resource_options(MTHeapDescriptor desc, MTResourceOptions options) {
    MT_MSG_SEND_1(void, desc, MT_SEL("setResourceOptions:"), MTResourceOptions, options);
}

MT_INLINE void mt_heap_descriptor_set_heap_type(MTHeapDescriptor desc, MTHeapType type) {
...
MT_INLINE MTStorageMode mt_heap_descriptor_get_storage_mode(MTHeapDescriptor desc) {
    return MT_MSG_SEND(MTStorageMode, desc, MT_SEL("storageMode"));
}

MT_INLINE MTCPUCacheMode mt_heap_descriptor_get_cpu_cache_mode(MTHeapDescriptor desc) {
    return MT_MSG_SEND(MTCPUCacheMode, desc, MT_SEL("cpuCacheMode"));
}

MT_INLINE MTSparsePageSize mt_heap_descriptor_get_sparse_page_size(MTHeapDescriptor desc) {
    return MT_MSG_SEND(MTSparsePageSize, desc, MT_SEL("sparsePageSize"));
}

MT_INLINE MTHazardTrackingMode mt_heap_descriptor_get_hazard_tracking_mode(MTHeapDescriptor desc) {
    return MT_MSG_SEND(MTHazardTrackingMode, desc, MT_SEL("hazardTrackingMode"));
}

MT_INLINE MTResourceOptions mt_heap_descriptor_get_resource_options(MTHeapDescriptor desc) {
    return MT_MSG_SEND(MTResourceOptions, desc, MT_SEL("resourceOptions"));
}

MT_INLINE MTHeapType mt_heap_descriptor_get_heap_type(MTHeapDescriptor desc) {
