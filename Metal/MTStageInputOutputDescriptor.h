...
// NOTE: This header currently provides the MTStageInputOutputDescriptor enums
// (MTIndexType, MTStepFunction) used by compute stage-in / indexed draws. The
// descriptor *object* wrappers (MTLStageInputOutputDescriptor + its attribute
// and layout arrays) are not wrapped yet — add them here when a use case needs
// them.
