...
MT_INLINE MTIndirectCommandBufferExecutionRange mt_indirect_command_buffer_execution_range_make(uint32_t location, uint32_t length) {
...
MT_INLINE MTIndirectRenderCommand mt_icb_get_render_command_at(MTIndirectCommandBuffer buffer, unsigned long index) {
    return MT_MSG_SEND_1(void*, buffer, MT_SEL("indirectRenderCommandAtIndex:"), unsigned long, index);
}

MT_INLINE MTIndirectComputeCommand mt_icb_get_compute_command_at(MTIndirectCommandBuffer buffer, unsigned long index) {
    return MT_MSG_SEND_1(void*, buffer, MT_SEL("indirectComputeCommandAtIndex:"), unsigned long, index);
}
