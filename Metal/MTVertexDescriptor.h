...
MT_INLINE MTVertexAttributeDescriptorArray mt_vertex_attribute_new_descriptor_array(void) {
...
MT_INLINE MTVertexBufferLayoutDescriptor mt_vertex_layout_array_get(MTVertexBufferLayoutDescriptorArray array, NSUInteger index) {
    return MT_MSG_SEND_1(void*, array, MT_SEL("objectAtIndexedSubscript:"), NSUInteger, index);
}
...
MT_INLINE MTVertexDescriptor mt_vertex_descriptor_create(void) {
    // Convenience factory returns an autoreleased object; retain so _create
    // uniformly means "+1 owned — caller must mt_release".
    return MT_RETAIN(MT_MSG_SEND_CLASS(void*, MT_CLASS("MTLVertexDescriptor"), MT_SEL("vertexDescriptor")));
}

MT_INLINE MTVertexBufferLayoutDescriptorArray mt_vertex_descriptor_get_layouts(MTVertexDescriptor desc) {
    return MT_MSG_SEND(void*, desc, MT_SEL("layouts"));
}

MT_INLINE void mt_vertex_descriptor_set_vertex_layout_stride(MTVertexDescriptor desc, NSUInteger index, NSUInteger stride) {
    id layoutArray = MT_MSG_SEND(void*, desc, MT_SEL("layouts"));
    id layout = MT_MSG_SEND_1(void*, layoutArray, MT_SEL("objectAtIndexedSubscript:"), NSUInteger, index);
...
MT_INLINE MTVertexAttributeDescriptorArray mt_vertex_descriptor_get_attributes(MTVertexDescriptor desc) {
    return MT_MSG_SEND(void*, desc, MT_SEL("attributes"));
}
...
MT_INLINE void mt_vertex_descriptor_set_vertex_attribute_format(MTVertexDescriptor desc, NSUInteger index, MTVertexFormat format) {
    id attrArray = MT_MSG_SEND(void*, desc, MT_SEL("attributes"));
    id attr = MT_MSG_SEND_1(void*, attrArray, MT_SEL("objectAtIndexedSubscript:"), NSUInteger, index);
...
MT_INLINE void mt_vertex_descriptor_set_vertex_attribute(MTVertexDescriptor desc, NSUInteger index, MTVertexFormat format, NSUInteger offset, NSUInteger bufferIndex) {
    id attrArray = MT_MSG_SEND(void*, desc, MT_SEL("attributes"));
    id attr = MT_MSG_SEND_1(void*, attrArray, MT_SEL("objectAtIndexedSubscript:"), NSUInteger, index);
    MT_MSG_SEND_1(void, attr, MT_SEL("setFormat:"), NSUInteger, format);
    MT_MSG_SEND_1(void, attr, MT_SEL("setOffset:"), NSUInteger, offset);
...
MT_INLINE void mt_vertex_descriptor_set_vertex_layout(MTVertexDescriptor desc, NSUInteger index, NSUInteger stride, NSUInteger stepRate, MTVertexStepFunction stepFunction) {
    id layoutArray = MT_MSG_SEND(void*, desc, MT_SEL("layouts"));
    id layout = MT_MSG_SEND_1(void*, layoutArray, MT_SEL("objectAtIndexedSubscript:"), NSUInteger, index);
    MT_MSG_SEND_1(void, layout, MT_SEL("setStride:"), NSUInteger, stride);
    MT_MSG_SEND_1(void, layout, MT_SEL("setStepRate:"), NSUInteger, stepRate);
...
MT_INLINE MTVertexAttributeDescriptor mt_vertex_descriptor_get_attribute(MTVertexDescriptor desc, NSUInteger index) {
    id attributes = MT_MSG_SEND(void*, desc, MT_SEL("attributes"));
    return MT_MSG_SEND_1(void*, attributes, MT_SEL("objectAtIndexedSubscript:"), NSUInteger, index);
}
...
MT_INLINE void mt_vertex_attribute_array_set_format(MTVertexAttributeDescriptorArray arr, NSUInteger index, MTVertexFormat format) {
    id attr = MT_MSG_SEND_1(void*, arr, MT_SEL("objectAtIndexedSubscript:"), NSUInteger, index);
    MT_MSG_SEND_1(void, attr, MT_SEL("setFormat:"), NSUInteger, format);
}
...
MT_INLINE MTVertexBufferLayoutDescriptor mt_vertex_descriptor_get_layout(MTVertexDescriptor desc, NSUInteger index) {
    id layouts = MT_MSG_SEND(void*, desc, MT_SEL("layouts"));
    return MT_MSG_SEND_1(void*, layouts, MT_SEL("objectAtIndexedSubscript:"), NSUInteger, index);
}
...
MT_INLINE void mt_vertex_layout_array_set_stride(MTVertexBufferLayoutDescriptorArray arr, NSUInteger index, NSUInteger stride) {
    id layout = MT_MSG_SEND_1(void*, arr, MT_SEL("objectAtIndexedSubscript:"), NSUInteger, index);
    MT_MSG_SEND_1(void, layout, MT_SEL("setStride:"), NSUInteger, stride);
}
